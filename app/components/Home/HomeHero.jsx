...
export default function HomeHero() {
  return (
    <div className='relative  flex flex-col lg:flex-row items-center 3xl:justify-center 3xl:bg-center /justify-between /pb-[70px]  lg:pr-[11px] pt-[167.33px] lg:pt-[80px] xl:pt-[0px] px-[24px] xl:px-[0px] xl:pl-[128px] text-[#FFFFFF] bg-[url(/bg-liness1.svg)]  xl:bg-[url(/bg-liness.svg)]  /bg-no-repeat md:bg-repeat xl:bg-no-repeat'>
