...
export default function HomeHero() {
  return (
    <div className='  flex flex-col lg:flex-row items-center justify-between /pb-[70px]  lg:pr-[11px] pt-[167.33px] lg:pt-[80px] xl:pt-[0px] px-[24px] xl:px-[0px] xl:pl-[128px] text-[#FFFFFF] bg-[url(/ssbg-lines.svg)]  xl:bg-[url(/bg-liness.svg)] bg-no-repeat lg:bg-repeat xl:bg-no-repeat'>
