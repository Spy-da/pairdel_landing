...
export default function Homesec1() {
  ...
  return (
    <div className='text-[#FFFFFF]  flex flex-col-reverse lg:flex-row gap-[64px] lg:gap-0 items-center justify-center lg:justify-between px-[24px] xl:px-[128px] py-[64px] lg:py-[135px] bg-[url(/ssbg-lines.svg)]  xl:bg-[url(/bg-liness.svg)] bg-no-repeat lg:bg-repeat xl:bg-no-repeat'>
